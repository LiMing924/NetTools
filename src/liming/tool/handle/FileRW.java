...
public enum FileRW {
	...
	public static String readFileString(File file, FileRW ENCODE) throws IOException {
	...
	public static boolean writeFileString(File file, String code, boolean append, FileRW ENCODE) throws IOException {
